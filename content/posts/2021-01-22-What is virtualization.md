...
## Type-1 Hypervisors
There are a few players in both of these spaces that are available. In the Type 1 category, we have [VMware’s vSphere (ESXi)](https://www.vmware.com/products/vsphere-hypervisor.html), [Microsoft’s Hyper-V](https://www.microsoft.com/en-us/evalcenter/evaluate-hyper-v-server-2019), Linux [QEMU](https://www.qemu.org/)/[KVM](https://www.linux-kvm.org/page/Main_Page), [Xen](https://xenproject.org/) and [XenServer](https://www.citrix.com/products/citrix-hypervisor/).

### [VMware’s vSphere (ESXi)](https://www.vmware.com/products/vsphere-hypervisor.html)
...
### [XenServer](https://www.citrix.com/products/citrix-hypervisor/)
